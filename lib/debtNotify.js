...
// seen before the automatic rollover turns an unpaid minimum into arrears
...
async function checkCycleReset() {
  ...
  await broadcast(
    `Your cycle is ${daysSinceStart} days old and renews shortly — any minimum still unpaid goes into arrears.`,
