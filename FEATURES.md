...
- **2.0 candidates scoped 2026-07-22** — see `FEATURES_2.0_IDEAS.md` for the index and the individual `*_SPEC.md` docs (calibration, job pipeline, scheduling, variations, final invoice, job templates, site notes).
